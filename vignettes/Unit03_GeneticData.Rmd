...
# urther subset Golub to B-cell ALL samples
...
> * In the biplot, probes lying far from the origin along PC1 or PC2 represent genes with the larges loadings, i.e., the greatest contribution to those principal components. Samples positioned similarly share expression patters in those genes.
